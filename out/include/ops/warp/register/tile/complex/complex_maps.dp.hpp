 ...
 */
template<ducks::crt::all T>
static inline void add(T &dst, const T &lhs, const T &rhs) {
 ...
 */
template<ducks::crt::all T>
static inline void sub(T &dst, const T &lhs, const T &rhs) {
...
template <ducks::crt::all T>
/*
DPCT1110:8: The total declared local variable size in device function mul
...
*/
static inline void mul(T &dst, const T &lhs, const T &rhs) {
 ...
 */
template<ducks::crt::all T>
static inline void div(T &dst, const T &lhs, const T &rhs) {
    using dtype = T::dtype;
    dtype tmp;
    dtype denom;
    // out of place storage regs
