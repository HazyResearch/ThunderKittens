...
static inline void unary_map(T &dst, const T &src) {
    #pragma unroll
 ...
 */
template<typename op, ducks::rt::all T>
static inline void bin_map(T &dst, const T &src, const typename T::dtype &param) {
    #pragma unroll
    for(int i = 0; i < dst.height; i++) {
        #pragma unroll
        for(int j = 0; j < dst.width; j++) {
 ...
 */
template<typename op, ducks::rt::all T>
static inline void bin_map(T &dst, const T &src, const typename base_types::packing<typename T::dtype>::unpacked_type &param) {
 ...
 */
template<typename op, ducks::rt::all T>
static inline void bin_map(T &dst, const T &lhs, const T &rhs) {
    #pragma unroll
    for(int i = 0; i < dst.height; i++) {
        #pragma unroll
        for(int j = 0; j < dst.width; j++) {
...
static inline void row_map(T &dst, const T &src, const V &row_values) {
    ...
    #pragma unroll
    for(int i = 0; i < dst.height; i++) {
        dtype packed_top_row = base_types::packing<dtype>::pack(
            row_values[i][0].x()); //  first value in eager mode
        dtype packed_bottom_row = base_types::packing<dtype>::pack(
            row_values[i][0].y()); // second value in eager mode
#pragma unroll
        for(int j = 0; j < dst.width; j++) {
            #pragma unroll
 ...
 */
template<typename op, ducks::rt::row_layout T, ducks::rv::all V>
static inline void row_map(T &dst, const T &a, const T &b, const V &row_values) {
 ...
 */
template<typename op, ducks::rt::row_layout T, ducks::rv::all V>
static inline void col_map(T &dst, const T &src, const V &col_values) {
 ...
 */
template<typename op, ducks::rt::row_layout T, ducks::rv::all V>
static inline void col_map(T &dst, const T &a, const T &b, const V &col_values) {
...
static inline void add_row(T &dst, const T &src, const V &row_values) {
    row_map<base_ops::sum, T, V>(dst, src, row_values);
}
template<ducks::rt::row_layout T, ducks::rv::ortho_layout V>
static inline T operator+(const T &src, const V &row_values) {
    T dst;
...
template<ducks::rt::row_layout T, ducks::rv::ortho_layout V>
static inline void operator+=(T &lhs, const V &row_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void sub_row(T &dst, const T &src, const V &row_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void mul_row(T &dst, const T &src, const V &row_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void div_row(T &dst, const T &src, const V &row_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void broadcast_row(T &dst, const V &row_values) {
    row_map<base_ops::copy2, T, V>(dst, dst, row_values);
}
template<ducks::rt::all T, ducks::rv::all V>
static inline T broadcast_row(const V &row_values) {
    T dst;
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void add_col(T &dst, const T &src, const V &col_values) {
    col_map<base_ops::sum, T, V>(dst, src, col_values);
}
template<ducks::rt::row_layout T, ducks::rv::align_layout V>
static inline T operator+(const T &src, const V &col_values) {
    T dst;
...
template<ducks::rt::row_layout T, ducks::rv::align_layout V>
static inline void operator+=(T &lhs, const V &col_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void sub_col(T &dst, const T &src, const V &col_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void mul_col(T &dst, const T &src, const V &col_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void div_col(T &dst, const T &src, const V &col_values) {
 ...
 */
template<ducks::rt::all T, ducks::rv::all V>
static inline void broadcast_col(T &dst, const V &col_values) {
    col_map<base_ops::copy2, T, V>(dst, dst, col_values);
}
template<ducks::rt::all T, ducks::rv::all V>
static inline T broadcast_col(const V &col_values) {
    T dst;
