...
static inline void ld_reduce_op(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
...
static inline void all_reduce_add(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<RV>>
static inline void all_reduce_min(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<RV>>
static inline void all_reduce_max(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
    ld_reduce_op<ReduceOp::MAX>(dst, src, dev_idx, idx);
}

template<ReduceOp OP, ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<RV>>
inline static void reduce_op(const PGL &dst, const RV &src, int dev_idx, const COORD &idx) {
    using T2 = RV::dtype;
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<RV>>
static inline void atomic_add(const PGL &dst, const RV &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<RV>>
inline static void broadcast(const PGL &dst, const RV &src, int dev_idx, const COORD &idx) {
    using T2 = RV::dtype;
    using U = typename PGL::dtype;
    using U2 = base_types::packing<U>::packed_type;
    using T = base_types::packing<T2>::unpacked_type;
