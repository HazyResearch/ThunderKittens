...
inline static void ld_reduce_op(RT &dst, const PGL &src, int dev_idx, const COORD &idx) {
    using T2 = RT::dtype;
...
inline static void all_reduce_add(RT &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<int axis, ducks::rt::row_layout RT, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<rt<typename RT::T, N_WARPS*RT::rows, RT::cols, typename RT::layout>>>
inline static void all_reduce_min(RT &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<int axis, ducks::rt::row_layout RT, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<rt<typename RT::T, N_WARPS*RT::rows, RT::cols, typename RT::layout>>>
inline static void all_reduce_max(RT &dst, const PGL &src, int dev_idx, const COORD &idx) {
...
inline static void reduce_op(const PGL &dst, const RT &src, int dev_idx, const COORD &idx) {
    using T2 = RT::dtype;
    using U = typename PGL::dtype;
    using U2 = base_types::packing<U>::packed_type;
 ...
 */
template<int axis, ducks::rt::row_layout RT, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<rt<typename RT::T, N_WARPS*RT::rows, RT::cols, typename RT::layout>>>
inline static void atomic_add(const PGL &dst, const RT &src, int dev_idx, const COORD &idx) {
 ...
 */
template<int axis, ducks::rt::row_layout RT, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<rt<typename RT::T, N_WARPS*RT::rows, RT::cols, typename RT::layout>>>
inline static void broadcast(const PGL &dst, const RT &src, int dev_idx, const COORD &idx) {
    using T2 = RT::dtype;
    using U = typename PGL::dtype;
    using U2 = base_types::packing<U>::packed_type;
