 ...
 * between pgls and register vectors.
 */
...
inline static void all_reduce_add(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<rv<typename RV::T, N_WARPS*RV::length, typename RV::layout>>>
inline static void all_reduce_min(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<rv<typename RV::T, N_WARPS*RV::length, typename RV::layout>>>
inline static void all_reduce_max(RV &dst, const PGL &src, int dev_idx, const COORD &idx) {
 ...
 */
template<ducks::rv::all RV, ducks::pgl::all PGL, ducks::coord::vec COORD=coord<rv<typename RV::T, N_WARPS*RV::length, typename RV::layout>>>
inline static void atomic_add(const PGL &dst, const RV &src, int dev_idx, const COORD &idx) {
