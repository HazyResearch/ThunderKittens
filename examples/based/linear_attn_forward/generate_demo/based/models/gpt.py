...
from based.hf import load_config_hf, load_state_dict_hf
...
class GPTModel(GPTPreTrainedModel):
    def __init__(self, config: GPT2Config, process_group=None, device=None, dtype=None):
        ...
        self.fused_dropout_add_ln = False # SA Flag getattr(config, "fused_dropout_add_ln", False)
