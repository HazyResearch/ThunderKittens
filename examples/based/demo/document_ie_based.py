...
def get_model(args, model_name="attn"): 
    ...
    if 'attn' in model_name:
        ...
        return GPTLMHeadModel.from_pretrained_hf("hazyresearch/attn-360m").to("cuda").to(torch.bfloat16)
    elif 'mamba' in model_name:
        from based.models.mamba import MambaLMHeadModel
        return MambaLMHeadModel.from_pretrained_hf("hazyresearch/mamba-360m").to("cuda").to(torch.bfloat16) 
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default="based", help='Name of the model')
