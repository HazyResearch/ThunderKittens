...
# set path as current file
import sys
sys.path.append('aaryan/dev/3/ThunderKittens/examples/attn')

from fa_ import benchmark_all, benchmark_forward, benchmark_backward
from fa_ import benchmark_fwd_bwd, benchmark_combined
