    ...
    CUtensorMap* tma_q, CUtensorMap* tma_k, CUtensorMap* tma_v, CUtensorMap* tma_o)
{
    ...
    // tma::load_async(k_smem[warpid], tma_k, kv_idx_warp, smem_barrier[warpid]);
    // tma::load_async(v_smem[warpid], tma_v, kv_idx_warp, smem_barrier[warpid]);
