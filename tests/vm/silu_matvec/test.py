...
def silu_mlp(post_ln: Tensor, up_proj: nn.Linear, down_proj: nn.Linear, gate_proj: nn.Linear) -> Tensor:
...
def go():
    silu_mlp(instructions, timings, UP_PROJ_W, DOWN_PROJ_W, GATE_PROJ_W, INP, O)
