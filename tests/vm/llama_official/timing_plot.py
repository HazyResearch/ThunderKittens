...
from bokeh.models import (
    ...
    Rect,
)  # Changed Segment to Rect  # Changed Segment to Rect
from bokeh.palettes import (
    Category10,
    Viridis256,
)  # Using Category10 for distinct instruction types  # Using Category10 for distinct instruction types
...
def save_gantt_chart_bokeh(
    ...
    save(
        p,
        filename=filename,
        title=f"Instruction Timeline {name if name else ''}",
        resources=CDN,
    )
