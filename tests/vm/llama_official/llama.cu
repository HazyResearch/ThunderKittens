...
PYBIND11_MODULE(kvm_llama, m) {
  ...
  kittens::py::bind_kernel<
      kvm<default_config, llama_1b_globals, attention_partial_op,
          attention_reduction_op, rms_qkv_rope_append_op, downproj_op,
          o_proj_op, rms_upgate_silu_op, rms_lm_head_op>>(
      m, "kvm_llama", &llama_1b_globals::Bar, &llama_1b_globals::instructions,
      ...
      &llama_1b_globals::rms_norm_eps, &llama_1b_globals::skip_attn_reduction);
}