...
#if defined(TEST_WARP_REGISTER_TILE_MUL_COMPLEX) || \
    defined(TEST_WARP_REGISTER_TILE_MMA_COMPLEX) || defined(TEST_WARP_REGISTER_TILE_CONVERSIONS_COMPLEX)
// We needn TEST_WARP_REGISTER_TILE for the complex tiles too
