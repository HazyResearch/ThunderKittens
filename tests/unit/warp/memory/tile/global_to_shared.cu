...
static __global__ void g2s_global_wrapper_2d(const GTL input, GTL output) {
...
struct load_store {
    ...
    template<int H, int W, int NW, kittens::ducks::gt::l::all GTL> __device__ static void device_func(const GTL input, GTL output) {
