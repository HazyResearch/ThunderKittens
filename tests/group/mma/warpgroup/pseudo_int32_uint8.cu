...
struct pseudo_shared_abt_test {
    ...
    static inline const std::string test_identifier =
        std::string("pseudo_warpgroup_") + (use_mma ? "mma_" : "mm_") + "ABt_int32_uint8";
...
struct pseudo_reg_shared_abt_test {
    ...
    static inline const std::string test_identifier =
        std::string("pseudo_warpgroup_reg_") + (use_mma ? "mma_" : "mm_") + "ABt_int32_uint8";
...
void group::mma::warpgroup::pseudo_int32_uint8::tests(test_data &results) {
    std::cout << " ----- Starting ops/mma/warpgroup/pseudo_int32_uint8 tests! -----\n" << std::endl;
