        ...
        namespace vm {
            ...
            struct uniform_args {
                ...
                __device__ uniform_args(
                    ...
                    int *_instruction) : common(_common),
            ...
            template <kittens_layout T>
            using common_setup_args = uniform_args<T>;
            ...
            struct producer_setup_args : uniform_args<T> {
                ...
                __device__ producer_setup_args(
                    ...
                    uniform_args<T> &_args) : uniform_args<T>(_args), state(_state) {}
            };
            ...
            struct producer_load_args : uniform_args<T> {
                ...
                __device__ producer_load_args(
                    ...
                    int _iter,
                    uniform_args<T> &_args) : uniform_args<T>(_args), input(_input), state(_state), inputs_arrived(_inputs_arrived), iter(_iter) {}
            };
            ...
            struct producer_store_args : uniform_args<T> {
                ...
                __device__ producer_store_args(
                    ...
                    int _iter,
                    uniform_args<T> &_args) : uniform_args<T>(_args), output(_output), state(_state), outputs_finished(_outputs_finished), iter(_iter) {}
            };
            ...
            struct consumer_compute_args<T> : uniform_args<T> {
                ...
                __device__ consumer_compute_args(
                    ...
                    int _iter,
                    uniform_args<T> &_args) : uniform_args<T>(_args), input(_input), output(_output), state(_state), inputs_finished(_inputs_finished), outputs_arrived(_outputs_arrived), iter(_iter) {}
            };
            ...
            struct consumer_finish_args : uniform_args<T> {
                ...
                __device__ consumer_finish_args(
                    ...
                    uniform_args<T> &_args) : uniform_args<T>(_args), finish(_finish), state(_state), finish_finished(_finish_finished) {}
            };
