...
template<int axis, bool assume_aligned, ducks::cst::all CST, ducks::cgl::all CGL, ducks::coord::st COORD>
...
template<ducks::cst::all CST, ducks::cgl::all CGL, ducks::coord::st COORD>
__device__ static inline void load(CST &dst, const CGL &src, const COORD &idx) {
