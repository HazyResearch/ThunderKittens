...
__device__ inline static void load(CRT &dst, const CGL &src, const coord<crt<typename CRT::T, N_WARPS*CRT::rows, CRT::cols, typename CRT::layout>> &idx) {
 ...
 */
template<int axis, ducks::crt::all CRT, ducks::cgl::all CGL>
...
template<ducks::crt::all CRT, ducks::cgl::all CGL>
__device__ inline static void store(CGL &dst, const CRT &src, const coord<crt<typename CRT::T, N_WARPS*CRT::rows, CRT::cols, typename CRT::layout>> &idx) {
