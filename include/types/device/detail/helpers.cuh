...
namespace detail {
    ...
    __host__ inline size_t init_mc_prop(CUmulticastObjectProp *mc_prop, int num_devices, size_t size) {
    ...
    __host__ inline CUmemAllocationProp init_mem_prop(CUmemAllocationProp *mem_prop, int device_id) {
    ...
    __host__ inline CUmemAccessDesc init_mem_desc(CUmemAccessDesc *desc, int device_id) {
