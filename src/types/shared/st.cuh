/**
 * @file
 * @brief The main ThunderKittens shared tile struct. This file also includes the row and column vector structs and various concept utilities.
 */
...
struct st {
    ...
    template<typename = std::enable_if_t<kittens::st_wgmma_layout<layout>>>
...
template<st_layout layout=st_xor_row_layout> using sv_bf_row_1 = typename st<bf16,1,1,layout>::row_vec;
template<st_layout layout=st_xor_row_layout> using sv_bf_row_4 = typename st<bf16,1,4,layout>::row_vec;

template<st_layout layout=st_xor_row_layout> using sv_bf_col_1 = typename st<bf16,1,1,layout>::col_vec;
template<st_layout layout=st_xor_row_layout> using sv_bf_col_4 = typename st<bf16,4,1,layout>::col_vec;

template<st_layout layout=st_xor_row_layout> using sv_fl_row_1 = typename st<float,1,1,layout>::row_vec;
template<st_layout layout=st_xor_row_layout> using sv_fl_row_4 = typename st<float,1,4,layout>::row_vec;

template<st_layout layout=st_xor_row_layout> using sv_fl_col_1 = typename st<float,1,1,layout>::col_vec;
template<st_layout layout=st_xor_row_layout> using sv_fl_col_4 = typename st<float,4,1,layout>::col_vec;
