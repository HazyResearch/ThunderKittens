...
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_row_64b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
    ...
    __device__ static inline int idx(int r, int c) { // naive row-major index default
        int idx1 = (c/cols_per_idx1);
        int idx2 = (r/16)*2 + (r%rows_per_core_matrix)/4;
        int idx3 = ((r%4)/2);
        int idx4 = (r%2)*4 + ((r%16)/8)*2 + (c%cols_per_idx1)/8;
        int idx5 = (c%cols_per_core_matrix);
        return (
            (((idx1 * (2*height) // height is in units of 16, but we want units of 8
             + idx2) * 2 // * 2 tensormaps across
...
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_row_128b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
...
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_col_0b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
...
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_col_32b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
    ...
    __device__ static inline int idx(int r, int c) { // naive row-major index default
        int idx1 = (r/rows_per_idx1);
        int idx2 = c/cols_per_core_matrix;
        int idx3 = (c%cols_per_core_matrix)/4;
...
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_col_64b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
    ...
    __device__ static inline int idx(int r, int c) { // naive row-major index default
        int idx1 = (r/rows_per_idx1);
        int idx2 = (c/16)*2 + (c%cols_per_core_matrix)/4;
        int idx3 = (c%4)/2;
        ...
        return (
            (((idx1 * (2*width) // height is in units of 16, but we want units of 8
             ...
             + idx4) * 8 // * 8 columns per row
             + idx5
        ) ^ (((c%cols_per_core_matrix)/4)*16 + idx3*8);
    }
};
template<int height, int width>
struct shared_indexer<height, width, st_wgmma_col_128b_layout> {
    static constexpr int rows = height*16;
    static constexpr int cols = width*16;
    static constexpr int rows_per_core_matrix = 8;
    static constexpr int cols_per_core_matrix = 8;
    ...
    __device__ static inline int idx(int r, int c) { // naive row-major index default
        int idx1 = (r/rows_per_idx1);
        int idx2 = (c/32)*4 + (c%cols_per_core_matrix)/2;
        int idx3 = c%2;
