...
template<detail::st_type_2d_tma_layout ST, int num_blocks, int itl, int swizzle>
__host__ static inline void create_tensor_map(CUtensorMap *tma_map, bf16 *src) {
    ...
    constexpr CUtensorMapInterleave   tma_interleave  = (itl == 0) ? CU_TENSOR_MAP_INTERLEAVE_NONE : 
                                                        (itl == 16) ? CU_TENSOR_MAP_INTERLEAVE_16B :
    ...
    constexpr CUtensorMapSwizzle      tma_swizzle     = (swizzle == 0) ? CU_TENSOR_MAP_SWIZZLE_NONE : 
                                                        (swizzle == 32) ? CU_TENSOR_MAP_SWIZZLE_32B :
                                                        (swizzle == 64) ? CU_TENSOR_MAP_SWIZZLE_64B :
                                                        (swizzle == 128) ? CU_TENSOR_MAP_SWIZZLE_128B :
...
template<detail::st_type_wgmma_row_layout ST, int num_blocks, int itl, int swizzle>
__host__ static inline void create_tensor_map(CUtensorMap *tma_map, bf16 *src) {
...
template<detail::st_type_wgmma_col_t_layout ST, int num_blocks, int itl, int swizzle>
__host__ static inline void create_tensor_map(CUtensorMap* tma_map, bf16 *src) {
