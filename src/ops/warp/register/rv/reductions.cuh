...
__device__ static inline void reduce(
        typename base_types::packing<typename T::dtype>::unpacked_type &accum,
        const RV &src,
        const typename base_types::packing<typename T::dtype>::unpacked_type &src_accum) {
    using T = base_types::packing<typename T::dtype>::unpacked_type;
    using T2 = typename T::dtype;
    int laneid = kittens::laneid();
    if constexpr (RV::inner_dim == 1) {
        accum = op::template op<T>(src[0][0].x, src[0][0].y);
        #pragma unroll
        ...
        accum = packed_shfl_sync(kittens::MASK_ALL, accum, 0);
    }
    ...
    else static_assert(false, "RV's can only have an inner dimension of 1 or 2!")
}
...
__device__ static inline void max(typename base_types::packing<typename T::dtype>::unpacked_type &max_val, const RV &src) {
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void min(typename base_types::packing<typename T::dtype>::unpacked_type &min_val, const RV &src) {
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void sum(typename base_types::packing<typename T::dtype>::unpacked_type &sum_val, const RV &src) {
    reduce<base_ops::add, RV, true>(sum_val, src, sum_val);
}
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void prod(typename base_types::packing<typename T::dtype>::unpacked_type &prod_val, const RV &src) {
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void max(typename base_types::packing<typename T::dtype>::unpacked_type &max_val, const RV &src, const typename base_types::packing<typename T::dtype>::unpacked_type &src_accum) {
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void min(typename base_types::packing<typename T::dtype>::unpacked_type &min_val, const RV &src, const typename base_types::packing<typename T::dtype>::unpacked_type &src_accum) {
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void sum(typename base_types::packing<typename T::dtype>::unpacked_type &sum_val, const RV &src, const typename base_types::packing<typename T::dtype>::unpacked_type &src_accum) {
    reduce<base_ops::add, RV, false>(sum_val, src, src_accum);
}
 ...
 */
template<ducks::rv::all RV>
__device__ static inline void prod(typename base_types::packing<typename T::dtype>::unpacked_type &prod_val, const RV &src, const typename base_types::packing<typename T::dtype>::unpacked_type &src_accum) {
