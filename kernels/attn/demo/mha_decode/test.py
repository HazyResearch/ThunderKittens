...
#     t0 = time.time()
#     # chunking = max(32, (round(1.03*sum(seq_lengths)*num_heads//NUM_PROCESSORS)//32)*32)
#     chunking = max(32, (round(0.255*sum(seq_lengths)*num_heads//NUM_PROCESSORS)//32)*32)
