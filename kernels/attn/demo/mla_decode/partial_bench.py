"""
Usage:
    python tk_bench_partial.py --batch 132 --tokens_per_batch 4 --iterations 1000 --sm_iters 1

This script benchmarks the partial stage of the MLA decode kernel.
It schedules a number of partial op tasks. Each task computes a partial op.
We pack 4 partial ops per group, and the total number of groups per SM is controlled
by the parameter --sm_iters.
"""
...
def main():
    ...
    parser.add_argument("--sm_iters", type=int, default=1, help="Number of groups (partial op iterations) per SM")
    ...
    parser.add_argument("--grid", type=int, default=None, help="Optional override for grid size")
