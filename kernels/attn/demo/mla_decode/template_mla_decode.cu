    ...
    struct producer {
        ...
        __device__ static inline void load(producer_load_args<layout> args) {
            if(warpgroup::warpid() == 0) {
                ...
                tma::load_async(args.input.c, args.globals.Cache, {0, next_page_id, within_page_idx, 0}, args.inputs_arrived);
#ifdef KITTENS_TIMINGS
                if(laneid() == 0 && args.iter < 24) args.timings[32+args.iter] = clock64();
#endif
            }
...
PYBIND11_MODULE(mla_decode, m) {
    ...
    kittens::py::bind_kernel<interpreter::kernel<OLD::config, OLD::partial_template, OLD::reduction_template>>(m, "mla_decode_old",
        &OLD::config::globals::instructions,
        &OLD::config::globals::Q,
        &OLD::config::globals::Cache,
        &OLD::config::globals::Table,
        &OLD::config::globals::O,
        &OLD::config::globals::O_scratch,
        &OLD::config::globals::Lvec_scratch,
        &OLD::config::globals::semaphore,
        &OLD::config::globals::Softmax_scale,
        &OLD::config::globals::tic
#ifdef KITTENS_TIMINGS
        , &OLD::config::globals::timings
#endif
    );
    kittens::py::bind_kernel<interpreter::kernel<NEW::config, NEW::partial_template, NEW::reduction_template>>(m, "mla_decode",
        &NEW::config::globals::instructions,
        &NEW::config::globals::Q,
        &NEW::config::globals::QV,
        &NEW::config::globals::K_cache,
        &NEW::config::globals::V_cache,
        &NEW::config::globals::Table,
        &NEW::config::globals::O,
        &NEW::config::globals::O_scratch,
        &NEW::config::globals::Lvec_scratch,
        &NEW::config::globals::semaphore,
        &NEW::config::globals::Softmax_scale,
        &NEW::config::globals::tic
#ifdef KITTENS_TIMINGS
        , &NEW::config::globals::timings
#endif
    );
