...
def should_skip(method_name, n, b, h, dv):
    if "FA3" in method_name and flash_attn_func3 is None:
        return True
    if "TK" in method_name and tk is None:
        return True
    return False
...
if __name__ == "__main__":
    run_benchmark_main(
        ...
        verbose=True,
        torch_compile=False,
        seq_lens=[768, 1536, 3072, 6144, 12288],
